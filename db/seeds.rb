...
peel_earings = Item.create(artist_id: gabby.id, item_title: "Orange Peel Earings", price: 40.00, quantity_available: 15, description: "Handcrafted by G. Lopez.", item_img_main: "../img/orange_peel_earings.jpg", item_img_thumb: "../img/orange_peel_earings.jpg")

crescent_earings = Item.create(artist_id: gabby.id, item_title: "Crescent Earings", price: 50.00, quantity_available: 15, description: "Handcrafted by G. Lopez.", item_img_main: "../img/crescent_earings.jpg", item_img_thumb: "../img/crescent_earings_thumb.jpg")

wind_ring = Item.create(artist_id: gabby.id, item_title: "Wind Ring", price: 74.00, quantity_available: 1, description: "One of a kind. Handcrafted by G. Lopez.", item_img_main: "../img/davinci.jpg", item_img_thumb: "../img/davinci_thumb.jpg")


# Rory

xxiii_print = Item.create(artist_id: rory.id, item_title: "XXIII Print", price: 18.00, quantity_available: 25, description: "Print of Rory's \"XXIII\".", item_img_main: "../img/xxiii.jpg", item_img_thumb: "../img/xxiii.jpg")

woods_print = Item.create(artist_id: rory.id, item_title: "Woods Print", price: 18.00, quantity_available: 25, description: "Print of Rory's \"Woods\".", item_img_main: "../img/woods.jpg", item_img_thumb: "../img/woods.jpg")
