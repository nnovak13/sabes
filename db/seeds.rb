...
peel_earings = Item.create(artist_id: gabby.id, title: "Orange Peel Earings", price: 40.00, quantity_available: 15, description: "Handcrafted by G. Lopez.", img_main: "../img/orange_peel_earings.jpg", img_thumb: "../img/orange_peel_earings.jpg")

crescent_earings = Item.create(artist_id: gabby.id, title: "Crescent Earings", price: 50.00, quantity_available: 15, description: "Handcrafted by G. Lopez.", img_main: "../img/crescent_earings.jpg", img_thumb: "../img/crescent_earings_thumb.jpg")

wind_ring = Item.create(artist_id: gabby.id, title: "Wind Ring", price: 74.00, quantity_available: 1, description: "One of a kind. Handcrafted by G. Lopez.", img_main: "../img/davinci.jpg", img_thumb: "../img/davinci_thumb.jpg")


# Rory

xxiii_print = Item.create(artist_id: rory.id, title: "XXIII Print", price: 18.00, quantity_available: 25, description: "Print of Rory's \"XXIII\".", img_main: "../img/xxiii.jpg", img_thumb: "../img/xxiii.jpg")

woods_print = Item.create(artist_id: rory.id, title: "Woods Print", price: 18.00, quantity_available: 25, description: "Print of Rory's \"Woods\".", img_main: "../img/woods.jpg", img_thumb: "../img/woods.jpg")

woods_painting = Item.create(artist_id: rory.id, title: "Woods Painting", price: 100.00, quantity_available: 1, description: "Purchase Rory's Original \"Woods\" painting.", img_main: "../img/woods.jpg", img_thumb: "../img/woods.jpg")

faces_print = Item.create(artist_id: rory.id, title: "Faces Print", price: 18.00, quantity_available: 25, description: "Print of Rory's \"Faces\".", img_main: "../img/faces.jpg", img_thumb: "../img/faces.jpg")

faces_painting = Item.create(artist_id: rory.id, title: "Faces Painting", price: 18.00, quantity_available: 1, description: "Purchase Rory's Original \"Faces\" painting.", img_main: "../img/faces.jpg", img_thumb: "../img/faces.jpg")
